...
$modalTitle = 'Novo planos de contas';

if ($_REQUEST['acao'] == 'editar') {
  $modalTitle = 'Editar plano de contas';
}
...
<form action="financeiro_planos_de_contas.php">
  <div class="col s12">
    ...
    <h5><?=$modalTitle;?></h5>
    <p>Preencha os dados para criar ou editar um plano de contas.</p>
    ...
    <!-- Ícones -->
    <div class="row">
      <div class="input-field col s12 mb-5 mt-2">
