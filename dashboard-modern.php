...
<html class="loading" lang="pt-Br" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Espaço Vita - Dashboard</title>
        ...
        <div class="col s12">
          <div class="container">
                  ...
                  <div class="card-content">
                    ...
                    <ul class="collection mb-0">
                      <li class="collection-item avatar">
                        ...
                        <a href="dashboard-modern.html#!" class="secondary-content"><i class="material-icons">star_border</i></a>
                      </li>
                      <li class="collection-item avatar">
                  ...
                  <table class="subscription-table responsive-table highlight">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>$ 1000.00</td>
                        <td class="center-align"><a href="dashboard-modern.html#"><i class="material-icons pink-text">clear</i></a></td>
                      </tr>
                      <tr>
                        <td>Aldin Rakić</td>
                        <td>ACME Pvt LTD.</td>
            ...
            <?php
              ...
              include "app-includes/modal/modal-intro.php";
            ?>
