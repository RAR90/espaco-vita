...
<aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
  ...
  >
    ...
    <li class="bold <?=(strpos($self, 'alunos_temporarios_form')>0?'active':'')?>"><a class="waves-effect waves-cyan " href="alunos_temporarios_form.php">
      <i class="material-icons">person_add</i><span class="menu-title" data-i18n="">Novo Aluno Temporário</span></a>
    </li>
