...
<html class="loading" lang="pt-Br" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/pages/professores-form.css">
    <!-- END: Page Level CSS-->
  ...
  >
                          ...
                          <form action="professores_form.php" class="pr-5">
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <input id="funcNome" name="funcNome" value="<?=$funcNome;?>" type="text" required>
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <input id="funcDataNascimento" name="funcDataNascimento" class="datepicker" value="<?=$funcDataNascimento;?>" type="date" required>
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <input id="funcCPF" name="funcCPF" class="maskCpf" value="<?=$funcCPF;?>" type="text" required>
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <input id="funcIdentidade" name="funcIdentidade" class="maskRg" value="<?=$funcIdentidade;?>" type="text" required>
                            ...
                            <div class="row">
                              <div class="input-field col s12">
                                ...
                                <input id="funcCelular" name="funcCelular" class="maskCelular" value="<?=$funcCelular;?>" type="text" required>
    ...
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="assets/js/scripts/professores-form.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
