...
<html class="loading" lang="pt-Br" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/pages/alunos.css">
    <!-- END: Page Level CSS-->
  ...
  >
                          ...
                          <table id="page-length-option" class="display">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-center">
                                  <a href="alunos_temporarios_form.php" class="btn-floating mb-1 btn-small btn-flat waves-effect waves-light pink accent-2 white-text">
    ...
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="assets/js/scripts/alunos.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
