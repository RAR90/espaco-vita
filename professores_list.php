...
<html class="loading" lang="pt-Br" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="app-assets/css/pages/professores-list.css">
    <!-- END: Page Level CSS-->
  ...
  >
    ...
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="app-assets/js/scripts/professores-list.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
