                        ...
                        <div class="col s12">
                          <table id="page-length-option" class="display">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                  <a href="eventos_form.php" class="btn-floating mb-1 btn-small btn-flat waves-effect waves-light pink accent-2 white-text">
