          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Recebíveis de Alunos</h5>
                  ...
                  <div class="card border-radius-6">
                    <div class="card-content">
                      ...
                      <table id="page-length-option" class="data-table">
                        <thead>
                          <tr>
                            <th style="width: 175px">Vencimento</th>
                            <th style="width: 175px">Valor</th>
                            <th>Nome</th>
                            <th style="width: 125px">Status</th>
                            <th class="text-center" style="width: 125px">Detalhes</th>
                            <th class="text-center" style="width: 125px">Dar Baixa</th>
                          </tr>
                        </thead>
                        <tbody>
