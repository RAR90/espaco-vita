          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title mt-0 mb-0">Contas a Pagar</h5>
                    ...
                    <div class="card-content">
                      ...
                      <div class="row">
                        <div class="col s12 p-0 mb-3">
                          <ul class="tabs">
                            <li class="tab col m3"><a class="active" href="#test1">INFRAESTRUTURA</a></li>
                            <li class="tab col m3"><a href="#test2">FUNCIONÁRIOS</a></li>
                            <li class="tab col m3"><a href="#test3">TERCEIRIZADOS</a></li>
                            <li class="tab col m3"><a href="#test4">AVULSOS</a></li>
                          </ul>
                        </div>
                        ...
                        <div id="test2" class="col s12">
                          <table style="width:100%" class="data-table">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td class="text-center">22/12/2019</td>
                                <td class="text-center">R$ 10800,00</td>
                        ...
                        <div id="test3" class="col s12">
                          <table style="width:100%" class="data-table">
                            ...
                            <tbody>
                              <tr>
                                <td class="text-center">22/12/2019</td>
                                <td class="text-center">R$ 400,00</td>
                                <td>TECLABS</td>
                                <td>Mensal</td>
                                <td class="blue-text text-center">Em dia</td>
                                <td class="text-center">
